-- NOTE: This file contains table structure only (no data rows).
-- Full dataset with INSERT statements available via the Udemy course:
-- "Advanced SQL: MySQL for Ecommerce Data Analysis" by John Pauler
-- Download from: your Udemy account → course resources
